...
var _reactCssModules = __webpack_require__(11);
...
var App = function (_Component) {
    ...
    _createClass(App, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement('div', { className: 'app', styleName: 'app' }, 'cool ! !!!!!', _react2.default.createElement('div', { className: 'container', onClick: this._handleClick }, 'App demo !'), _react2.default.createElement('div', { onClick: this.handleAddTodo }, todos.map(function (_ref) {
                var text = _ref.text,
...
// module
exports.push([module.i, ".app__app___3MFEG {\n  color: red; }\n  .app__app___3MFEG .container {\n    background-color: orange; }\n", "", {"version":3,"sources":["D:/myDoc/myRepo/demo/src/view/page/app/app.scss"],"names":[],"mappings":"AAAA;EACE,WAAW,EAAE;EACb;IACE,yBAAyB,EAAE","file":"app.scss","sourcesContent":[".app {\n  color: red; }\n  .app :global .container {\n    background-color: orange; }\n"],"sourceRoot":""}]);
