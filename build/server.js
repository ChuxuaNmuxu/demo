...
console.log('styles: ', _app2.default);
...
var App = function (_Component) {
    ...
    _createClass(App, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement('div', { className: _app2.default.app }, 'cool ! !!!!!', _react2.default.createElement('div', { className: 'container', onClick: this._handleClick }, 'App demo !'), _react2.default.createElement('div', { onClick: this.handleAddTodo }, todos.map(function (_ref) {
                var text = _ref.text,
...
exports.default = (0, _reactRedux.connect)(mapStateToState, mapDispatchToProps)(App);
